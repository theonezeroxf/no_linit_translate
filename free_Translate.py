...
import yaml
input_dir='D:\code\Translate\InfinityMageNovel-main\Infinity Mage Chapters 1-1277'
output_dir='D:\code\Translate\InfinityMageNovel-main\ko2zh'
input_filename='Chapter - 43 - 리미트리스(2) 8.txt'
# 
modify_dir='D:\code\Translate\InfinityMageNovel-main\zh_modify'
dictionary={'西罗尼':'西罗纳','西罗娜':'西罗纳','白音':'西罗纳','西罗妮':'西罗纳','雪隆':'罗纳','雪音':'罗纳'}
one_file='D:\code\Translate\InfinityMageNovel-main\Infinite_Mage.txt'
...
def save_config_file():
    ...
    print('config.yaml saved in '+os.curdir)
